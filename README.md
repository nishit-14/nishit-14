...
Computer Science student at San Jose State University building backend, full-stack, DevOps, and AI-powered applications.

I enjoy building software that solves real workflow problems — from backend APIs and databases to full-stack apps, automation tools, mobile apps, and cloud-ready systems.

- B.S. Computer Science at San Jose State University
- Business Minor | GPA: 3.8
- [AWS Certified Cloud Practitioner](https://www.credly.com/badges/a8f4dca0-f231-4740-b040-77b779d8ddd2/public_url)
- Interested in backend engineering, DevOps, cloud infrastructure, AI workflows, and scalable systems
...
- Resume: [View Resume](./Nishit_Oberoi_Resume_2026.pdf)
...
### Backend Software Engineer Intern – Jaxel

- Built and shipped backend services using Spring Boot 3, MySQL, Flyway, Redis, JWT, and OpenAPI
- Helped modernize services to Spring Boot 3 and Spring Security 6
- Dockerized services and supported CI/CD workflows with GitLab CI

### Backend Developer – San Jose Consulting Group

- Built backend APIs for an AI-powered learning platform using Node.js, Express, and MongoDB Atlas
- Implemented real-time TTS/STT pipelines using OpenAI and Deepgram
- Built RAG workflows using Pinecone and LangChain for flashcards, quizzes, and tutoring features

## Tech Stack

**Languages:** Java, Python, JavaScript, TypeScript, SQL, C, Go  
**Backend:** Spring Boot, FastAPI, Node.js, Express.js, Flask, REST APIs  
**Frontend:** React, React Native, Expo, Vite, Tailwind, Bootstrap  
**Databases:** MySQL, PostgreSQL, MongoDB, Redis, Supabase  
**DevOps / Cloud / Tools:** Docker, Kubernetes, GitHub Actions, GitLab CI, Linux, AWS, Prometheus, Grafana, Jaeger, OpenTelemetry, Postman, Maven  
**AI / Data:** OpenAI API, Deepgram, Pinecone, LangChain, OCR workflows, Pandas, NumPy, Scikit-learn, Matplotlib
...
- Building production-style projects that showcase scalable systems
